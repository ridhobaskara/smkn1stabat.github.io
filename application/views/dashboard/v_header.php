...
<head>
	...
	<title>Administrator SMKN 1 Stabat | Dashboard</title>
	<link href="<?php echo base_url(); ?>gambar/website/logo-sekolah-smk.png" rel="icon">
	...
	<div class="wrapper">
		...
		<header class="main-header">			
			<a href="<?php echo base_url(); ?>" class="logo" img>
				...
				<span class="logo-lg"><img src="<?php echo base_url(); ?>assets/dist/img/logo-sekolah.png" width="50px"> <b>SMKN 1 Stabat</b></span>
			</a>
