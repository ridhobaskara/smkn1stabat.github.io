...
<head>
  ...
  <title>Login SMKN 1 STABAT </title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <img src="<?php echo base_url(); ?>assets/dist/img/logo-sekolah.png" width="75px">
      <a href="<?php echo base_url(); ?>index.php"><b>SMKN 1 STABAT</b> </a>
    </div>
    <!-- /.login-logo -->
